...
/* SP Tính lương (Logic: Snapshot lương VÀ Phạt vào bảng tạm -> Ghi sau) */
...
BEGIN
    ...
    BEGIN TRY
        ...
        -- (Trong Demo T1 sẽ có WAITFOR DELAY ở đây)

        -- ======================================================
        -- BƯỚC 2: TÍNH TOÁN & GHI (DỰA TRÊN DỮ LIỆU ĐÃ SNAPSHOT)
