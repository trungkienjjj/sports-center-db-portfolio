...
/*
 * Cập nhật thông tin dịch vụ chi nhánh (sp_update_branch_service)
 * 
 * Chức năng:
 ...
 * ====================================================================
 */
CREATE OR ALTER PROCEDURE sp_update_branch_service
    @BranchServiceID   INT,
...
PRINT N'=== ĐÃ TẠO STORED PROCEDURE: sp_update_branch_service ===';
GO
...
-- 1. Tăng tồn kho thêm 100
EXEC sp_update_branch_service
    @BranchServiceID = 1,
    @StockQuantity = 100;

-- 2. Giảm tồn kho đi 50
EXEC sp_update_branch_service
    @BranchServiceID = 1,
    @StockQuantity = -50;

-- 3. Tăng giá và tăng tồn kho
EXEC sp_update_branch_service
    @BranchServiceID = 1,
    @UnitPrice = 30000,
    @StockQuantity = 200;

-- 4. Chỉ cập nhật trạng thái
EXEC sp_update_branch_service
    @BranchServiceID = 1,
    @Status = N'Hết';

-- 5. Thử giảm tồn kho quá mức (sẽ báo lỗi)
EXEC sp_update_branch_service
    @BranchServiceID = 1,
    @StockQuantity = -1000;